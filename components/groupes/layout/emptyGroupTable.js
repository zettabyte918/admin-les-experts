            ...
            <div className="mt-4">
              <div className="-mx-2 -my-1.5 flex">
                <Link href={"/groupes/ajouter"}>
                  <a className="bg-red-300 px-2 py-1.5 rounded-md text-sm font-medium text-red-800 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red-50 focus:ring-red-600">
                    Nouvel groupe
                  </a>
                </Link>
              </div>
